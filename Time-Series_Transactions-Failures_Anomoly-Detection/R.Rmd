...
ggplot(data = failed_transactions, aes(x = x_index, y = failedTransactions)) + 
  ...
  theme(
    ...
    panel.grid.minor.x = element_blank(),  # Add minor grid lines
...
ggplot(data = failed_transactions, aes(x = x_index, y = failedTransactions)) + 
  ...
  theme(
    ...
    plot.background = element_rect(fill = "white", color = NA),
    panel.background = element_rect(fill = "white", color = NA),
    panel.grid.major.x = element_line(color = "gray", linewidth = 0.1),  # Very thin major x grid lines
    panel.grid.minor.x = element_line(color = "lightgray", linewidth = 0.05),  # Very thin minor x grid lines
    panel.grid.major.y = element_blank(), 
    legend.position = c(0.09, 0.9),  
    legend.background = element_rect(fill = "white", color = "black", size = 0.1),  
    legend.key.size = unit(0.01, "lines"),  
