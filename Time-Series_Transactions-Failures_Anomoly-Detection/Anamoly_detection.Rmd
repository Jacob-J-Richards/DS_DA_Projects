...
```{r}
ggplot(data=try,aes(proportion_c)) + geom_density() + labs(title="distribution of normal entire span")
ggplot(data=try,aes(proportion_subset)) + geom_density() + labs(title="distribution of anamoly entire span")
