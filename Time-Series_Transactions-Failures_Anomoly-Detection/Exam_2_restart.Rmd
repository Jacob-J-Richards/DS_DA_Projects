...
rest_of_data_set_failure_count_by_merchant

rest_of_data_transaction_count_by_merchant
...
colnames(entire_set_failures_by_merchant) <- c("Merchant","Failures","Failure_rate_Before_Anamoly",
                                               "Failure_Rate_During_Anamoly", "Difference_between_Failure_Rate")

entire_set_failures_by_merchant <- entire_set_failures_by_merchant[c("Merchant","Failure_rate_Before_Anamoly","Failure_Rate_During_Anamoly",
