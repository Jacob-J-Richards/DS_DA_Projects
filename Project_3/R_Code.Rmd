...
no_rent_change: 0 if rent change was less than 10% COL 2 rent_change_10: 0 if was 10% COL 3 rent_change_20: 0 if was 20% COL 4
...
less_10_rent_changed_renewed
less_10_rent_changed_did_not_renewed

(nrow(less_10_rent_changed_renewed)/nrow(less_10_rent_changed))

(nrow(less_10_rent_changed_did_not_renewed)/nrow(less_10_rent_changed))
