...
setwd("/Users/jacobrichards/Desktop/DS_DA_Projects/90+_DaysPastDue")

train <- read.csv(
  file = "~/Desktop/DS_DA_Projects/90+_DaysPastDue/Data_Files/FITB_train.csv", 
  header = TRUE
)

test <- read.csv(
  file = "~/Desktop/DS_DA_Projects/90+_DaysPastDue/Data_Files/FITB_test.csv", 
  header = TRUE
)
