...
Clearly this is a problem. Let's cut out the 1% tails on both ends on the training set. 
...
ggplot(data=feature_3_winsor_clean,aes(feature_3)) + geom_density()

colnames(feature_3_winsor_clean)[colnames(feature_3_winsor_clean) == "feature_3"] <- "feature_3_winsor"
