...
```{r}
library(fmsb)
riskratio(RR[1,1], RR[2,1], nrow(RENT_INCREASE), nrow(NO_RENT_INCREASE), conf.level=0.95, p.calc.by.independence=TRUE) 
```
...
riskratio(RR[1,1], RR[2,1], nrow(RENT_INCREASE_10), nrow(NO_RENT_INCREASE), conf.level=0.95, p.calc.by.independence=TRUE) 
```
...
riskratio(RR[1,1], RR[2,1], nrow(RENT_INCREASE_20), nrow(NO_RENT_INCREASE), conf.level=0.95, p.calc.by.independence=TRUE) 
```
