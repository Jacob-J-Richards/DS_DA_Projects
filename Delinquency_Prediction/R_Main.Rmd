...
Or even if the variables are not the **response** to a common **predictor**,
...
Features 1 and 3 have a correlation of 0.62, this doesn't mean that multi-collinearity is necessarily occurring as we don't even know what these variables represent. But it could be the case so let's see what happens if we remove one.
