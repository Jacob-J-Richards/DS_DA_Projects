...
kable(confusion_table, format = "html") %>%
  kable_styling(position = "center") %>%
  save_kable(file = "~/Desktop/DS_DA_Projects/Delinquency_Prediction/ReadMe_files/figure-gfm/gt_table_image.png", zoom = 2)

knitr::include_graphics("~/Desktop/DS_DA_Projects/Delinquency_Prediction/ReadMe_files/figure-gfm/gt_table_image.png")
