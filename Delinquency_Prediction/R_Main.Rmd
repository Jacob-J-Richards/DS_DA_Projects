...
+:============:+:================:+:================:+:==========:+:=======:+:=======:+:=======:+:=======:+
| 39.16508528  | 60.25377         | 137.9861         | -35.462685 | 50501   | 2000    | active  | 1       |
+--------------+------------------+------------------+------------+---------+---------+---------+---------+
| -12.61428906 | 57.95924         | 126.2123         | 44.420647  | 50501   | 2001    | 90+DPD  | 2       |
+--------------+------------------+------------------+------------+---------+---------+---------+---------+
| 0.04381321   | -39.29391        | 138.6872         | 64.944112  | 50501   | 2002    | active  | 3       |
+--------------+------------------+------------------+------------+---------+---------+---------+---------+
| 2.29698365   | 49.99669         | 123.7825         | -3.587873  | 50501   | 2003    | active  | 4       |
+--------------+------------------+------------------+------------+---------+---------+---------+---------+
| 7.18889687   | -83.53323        | 150.1020         | 95.359641  | 50501   | 2004    | active  | 5       |
+--------------+------------------+------------------+------------+---------+---------+---------+---------+
...
Since the outcome of whether or not there will be late payments is known in our testing data. We can asses the accuracy of the model by evaluating the model on the testing data and directly comparing the predicted outcomes and the actual outcomes, as well we can asses the impact our set **decision threshold** had on the models accuracy.

# *The testing data is separate from the data from which the model was produced from and thus it's performance on this data has implications for it's performance on other future data.* 
...
+:======================:+:==================:+:==================:+:==================:+:=======:+:==========:+:=======:+
| 0.16072699             | -0.9909613         | 0.01208607         | 0.9929802          | 50821   | 2000-12-31 | active  |
+------------------------+--------------------+--------------------+--------------------+---------+------------+---------+
| 0.12107646             | -0.3266923         | -0.93792201        | -0.3276696         | 50821   | 2001-12-31 | active  |
+------------------------+--------------------+--------------------+--------------------+---------+------------+---------+
| -0.09594818            | -0.8987632         | -2.17675805        | -0.6579547         | 50821   | 2002-12-31 | active  |
+------------------------+--------------------+--------------------+--------------------+---------+------------+---------+
| 0.58368733             | 0.9402138          | 1.32935457         | -0.2791657         | 50821   | 2003-12-31 | active  |
+------------------------+--------------------+--------------------+--------------------+---------+------------+---------+
| 0.03991450             | -1.4503831         | -0.41522270        | 1.2680076          | 50821   | 2004-12-31 | active  |
+------------------------+--------------------+--------------------+--------------------+---------+------------+---------+
