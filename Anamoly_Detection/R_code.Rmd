...
Unfortunately, the result is white noise. This is not the exact problematic combination. Rather than checking each manually we check every combination programmatically with some quick and dirty code.
...
The plot of UPI for payment method and UPI_COLLECT for sub-type reveals that this is the combination of variables within the PAYTM payment gateways that is casing customer complaints.
...
[shiny dashboard of failure rate and transaction](https://jacob-j-richards.shinyapps.io/shiny/ "open in a new tab")[volume](https://jacob-j-richards.shinyapps.io/shiny/)
