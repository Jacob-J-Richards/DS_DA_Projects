...
ok so what we should do is monitor the failure rate by the combinations of pmt, pg, and subtype, there are actually fewer combinations than you would expect as some variables are mutually exclusive with others

you need to make a shiny dashboard for this
