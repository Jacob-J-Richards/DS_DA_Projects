...
The following graphics displays the distribution of the anamolous data over a shifting 18 hour time window of first 18 hours of the dataset until the last 18 hours of the data set out of the 72.

```{=html}
![Density Plot Animation](ReadMe_files/figure-gfm/density_animation_high_quality.gif)
```
The distribution of the anomalous data over the entire 72 hours is as follows.
