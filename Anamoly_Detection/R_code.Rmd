...
```{r}
paytm_subset <- data[(data[, 5] %in% c("PAYTM", "PAYTM_V2", "PAYTM_UPI")) & 
...
The failure rate spike occurred from 5pm on the 13th to 6am on the 14th which is the day that merchants reported customer complaints.
