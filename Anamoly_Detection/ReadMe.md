...
```
    ...
    ## totall transactions in sample of observations from normal data of equal size to number of anamoly observations. 13782
...
``` html
<div>
  <a href="https://jacob-j-richards.shinyapps.io/shiny/" target="_blank">Click here to use the Shiny App</a>
</div>
```
